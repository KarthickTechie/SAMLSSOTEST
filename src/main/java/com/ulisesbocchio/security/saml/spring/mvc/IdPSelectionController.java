...
public class IdPSelectionController {
    ...
    public ModelAndView idpSelection(HttpServletRequest request) {
        ...
        if (comesFromDiscoveryFilter(request)) {
            System.out.println("request.getAttribute(SAMLDiscovery.RETURN_URL"+request.getAttribute(SAMLDiscovery.RETURN_URL));
            System.out.println( "request.getAttribute(SAMLDiscovery.RETURN_PARAM"+request.getAttribute(SAMLDiscovery.RETURN_PARAM));
            ...
            System.out.println("idpNameAliasMap "+idpNameAliasMap);
            System.out.println("idpNameAliasMap 0"+idpNameAliasMap.get(0));
